...
HD_PWD='/home/hari/Documents/Projects/RISC-V/Verilog_implementations/RV32I_SSP/RV32I_SSP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_Intergration_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_Intergration_0.tcl -notrace
